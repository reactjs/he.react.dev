...
אין הגבלה של ילד יחיד לכל קומפוננטה. אפשר להעביר ילדים מרובים, ואפילו ״משבצות״ ("slots") מרובות לילדים, [כמתועד כאן](/docs/composition-vs-inheritance.html#containment):
...
כל הצרכנים שהם צאצאים של ספק, ירונדרו בכל שינוי ב-prop `value`. ההפצה מהספק לצאצאיו הצרכנים (כולל [.contextType](/docs/context.html#classcontexttype) ו-[useContext](/docs/hooks-reference.html#usecontext)) אינה כפופה למתודה `shouldComponentUpdate`, כך שהצרכן מתעדכן אפילו כשקומפוננטה מעליו מדלגת על העדכון.  
