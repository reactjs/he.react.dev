...
>הערה
>
>React 16.8.0 היא הגרסא הראשונה שתומכת ב-Hooks. בעת שדרוג, לא לשכוח לעדכן את כל הספריות, כולל.React Dom 

>React Native תומך ב-Hooks מאז [השחרור של גרסה 0.59](https://facebook.github.io/react-native/blog/2019/03/12/releasing-react-native-059).
