...
כדי לפתור זאת, **Hooks נותן לנו לפצל קומפוננטה אחת לכמה פונקציות קטנות יותר בהתבסס על הקשרם (כמו להגדיר מנוי או משיכת נתונים)**, במקום להכריח פיצול המבוסס מתודות במחזור החיים.  תוכל גם לבחור ב-reducer לניהול ה-state המקומי של הקומפוננטה כדי להפוך אותה לצפוייה יותר.
