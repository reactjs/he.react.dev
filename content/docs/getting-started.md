...
אם אתם מעוניינים לשחק עם React, תוכלו להשתמש במגרש משחקים של קוד אונליין. נסו את תבנית שלום עולם על [CodePen](codepen://hello-world) או [CodeSandbox](https://codesandbox.io/s/new).
...
### מדריך פרקטי {#practical-tutorial}
