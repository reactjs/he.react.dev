...
מפתחות עוזרות ל-React לזהות אילו פריטים השתנו, נוספו או נמחקו. מפתחות אמורים להינתן לאלמנטים בתוך המערך כדי לתת לאלמנטים זהות קבועה:
...
מפתחות חייבים להיות ייחודיים בין אחים. למרות זאת הם לא צריכים להיות ייחודיים באופן גלובאלי. אנחנו יכולים להשתמש באותם מפתח כאשר שאנו מייצרים שני מערכים שונים.
...
עם הדוגמה למטה, קומפוננטת `Post` יכולה לקרוא `props.id` אבל לא את `props.key`.
