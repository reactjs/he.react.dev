...
פונקציה זו היא קומפוננטת React חוקית משום שהיא מקבלת ארגומנט אובייקט נתונים יחיד מסוג "props" (קיצור של המילה 'מאפיינים', properties באנגלית) ומחזירה אלמנט React. אנו מכנים קומפוננטות כאלה "קומפוננטת פונקציה" משום שהם פשוט פונקציות JavaScript.
